...
import dev.lukamadness.madnesscore.common.client.render.clothing.model.DyeableJacketModel;
...
public class DyeableJacketRenderer extends DyeableGeoArmorRenderer<DyeableJacketItem> {
    public DyeableJacketRenderer() {
        super(new DyeableJacketModel());
    }
