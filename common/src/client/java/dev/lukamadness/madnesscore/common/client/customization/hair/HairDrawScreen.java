package dev.lukamadness.madnesscore.common.client.customization.hair;
...
import dev.lukamadness.madnesscore.common.client.customization.skin.SkinPartSelectScreen;
...
public class HairDrawScreen extends Screen {
    ...
    public HairDrawScreen(Screen parent, CustomizationConfig cfg, SkinRegion region) {
        super(Component.translatable("madnesscore.config.draw.title_hair"));
        this.parent = parent;
        this.cfg = cfg;
        this.region = region;
    ...
    private void openPartSelector() {
        ...
        this.minecraft.setScreen(new SkinPartSelectScreen(this, cfg, region));
    }
