...
import dev.lukamadness.madnesscore.common.client.compatibility.environment.OsUtils;
    ...
    public static ControlValueFormatter biomeBlend() {
        return (v) -> {
            if (v < 0 || v > 7) {
                ...
                int sv = 2 * v + 1;
                return Component.translatable("madnesscore.config.options.biome_blend.value", sv, sv);
            }
        };
    }
