...
public class EyePartSelectScreen extends Screen {
    ...
    public EyePartSelectScreen(Screen parent, CustomizationConfig cfg, SkinRegion currentRegion) {
    ...
    protected void init() {
        ...
        this.addRenderableWidget(new FlatButtonWidget(
                ...
                () -> this.minecraft.setScreen(new EyeDrawScreen(parent, cfg, currentRegion)),
                true, false));
    ...
    public boolean mouseClicked(double mouseX, double mouseY, int button) {
        ...
        if (clicked != null) {
            this.minecraft.setScreen(new EyeDrawScreen(parent, cfg, clicked));
            return true;
        }
