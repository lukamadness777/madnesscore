...
/**
 * Calcula, cuadro a cuadro, qué grupo de slots dinámicos está "abierto" bajo el mouse (y dónde
 * dibujar el panel {@code more_slots.png} que lo rodea), y dibuja ese panel + los grupos extra que
 * no entran en las primeras 4 columnas junto al ícono del jugador.
 * <p>
 * Puramente cliente: no participa en absoluto de la lógica de items (eso lo maneja
 * {@code MixinInventoryMenu}, sourceSet "main"), solo decide layout y dibuja.
 * <p>
 * Portado de dev.emi.trinkets.TrinketScreenManager.
 */
public final class SlotHoverManager {
    ...
    public static void update(float mouseX, float mouseY) {
        ...
        if (group == null) {
            for (SlotGroup g : dev.lukamadness.madnesscore.common.slots.SlotsApi
    ...
    public static boolean isClickInsideBounds(double mouseX, double mouseY) {
        ...
        return currentBounds.contains(mx, my);
    }
